...
function Homeintro() {
  return (
      ...
      <div className="row boxintro " id="home">
        ...
        <br/>
        <a href= "https://drive.google.com/file/d/1HhrMimuladKc5j3DS0WmeG2Qbtk4CcFU/view?usp=sharing"  target="_blank"><button className="btn btn-outline-warning" id="resumedownload">Check out My Resume <BsArrowRight size={"1.5em"}/></button></a>  
      </div>
      </div>
