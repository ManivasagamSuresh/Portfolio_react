...
function Homeintro() {
  return (
      ...
      <div className="row boxintro " id="home">
        ...
        <br/>
        <a href= "https://drive.google.com/file/d/1lCOcKf6bIdYUrCZP9jBco0PBIbfsUDuI/view?usp=share_link"  target="_blank"><button className="btn btn-outline-warning" id="resumedownload">Download CV</button></a>  
      </div>
      </div>
