    ...
    <div className="col-lg-12">
      <div  className="card" >
        ...
        <div className="card-body">
          ...
          <img src={myntra} alt="" style={{width:"340px",height:"200px",padding:"20px"}}/>
        </div>
        </div>
    ...
    <div className="col-lg-12">
      <div  className="card" >
        ...
        <div className="card-body">
         ...
         <div className='card-i'>
          <img src={youtube} alt="" style={{width:"340px",height:"200px",padding:"20px"}}/>
        </div>
      ...
      <div  className="card" >
        ...
        <div className='card-d'>
          ...
          <div className='card-i'>
          <img src={chat} alt="" style={{width:"340px",height:"200px",padding:"10px"}}/>
        </div>
        </div>
      </div>
      </div>
      ...
      <div  className="card" >
        ...
        <div className='card-d'>
          ...
          <div className='card-i'>
          <img src={catalog} alt="" style={{width:"340px",height:"200px",padding:"20px"}}/>
        </div>
        </div>
      </div>
      </div>
